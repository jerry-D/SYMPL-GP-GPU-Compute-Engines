...
input [31:0] rdSrcAdata, rdSrcBdata,wrsrcAdata;
...
reg [33:0] fwrsrcAdata;
reg [33:0] fwrsrcBdata;
...
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        fwrsrcAdata <= 34'h00000000;
        fwrsrcBdata <= 34'h00000000;
    end
    else if (&const_q1 && (opcode_q1==MOV_)) begin        // MOV immediate
            fwrsrcAdata <= {16'h0000, OPsrcA_q1, OPsrcB_q1};
            fwrsrcBdata <= wrdataB_FP; 
    end        
    else begin     // any combination of direct or indirect
        fwrsrcAdata <= wrdataA_FP;             
        fwrsrcBdata <= wrdataB_FP; 
    end
end    
