...
// Version:  2.06  January 18, 2016
// Copyright (C) 2014-2016.  All rights reserved.
//
// latency for exp is 7 clocks
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                //
...
reg [31:0] nA;
reg [5:0] delay0, delay1, delay2, delay3, delay4, delay5, delay6;
...
assign invalid = (A_is_NaN  & ~nA[22]) & wren;
...
assign A_is_infinite_del = delay6[5];
assign invalid_del = delay6[4];
assign wrenq = delay6[3];
assign wraddrsq = delay6[2:0];             
...
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        ...
        nA_FPq <= nA_FP;
        rounded <= roundit & delay5[5];  //1-clock early wrenq
    end
end   
...
always@(posedge CLK or posedge RESET) begin
    if (RESET) begin
        ...
        delay0  <= {A_is_infinite, invalid, wren, wraddrs};
        delay1  <= delay0;    
        delay2  <= delay1;    
        delay3  <= delay2;
        delay4  <= delay3; 
