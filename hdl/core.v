...
reg [1:0] thread_q1;
reg [11:0] pc_q1;
reg [1:0] const_q1;         // 00 = no const lookup, 10 = srcA, 01 = srcB, 11 = immediate
reg [3:0] opcode_q1;
reg [13:0] srcA_q1;
reg [13:0] srcB_q1;
reg [7:0] OPdest_q1;
...
assign fp_sel_q1 = (((~|srcA_q1[12:8] & srcA_q1[7]) & ~const_q1[1]) | ((~|srcB_q1[12:8] & srcB_q1[7]) & ~const_q1[0])) & ~(opcode_q1==BTB_);
...
assign rdprog = 1'b1; 
assign rdsrcA = rdcycl & ~const[1]; 
assign rdsrcB = rdcycl & ~const[0]; 
...
assign rdconstA =  const[1] & ~const[0];
...
assign  tr0_STATUSq2 = {2'b10,
                       14'b0000_0000_0000_00,
                         ...
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[16] : tr0_IRQ_IE,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[15] : tr0_EXC_IE,
                         NaN_q2,
                         INF_q2,
                         DML_q2,                         
                         NML_q2,                         
                         SZ_q2,                                     
                         FPN_q2,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[7] : tr0_done, 
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[6] : tr0_locked,
                         V_q2,     
                         N_q2,     
                         C_q2,     
                         Z_q2
...
assign  tr1_STATUSq2 = {2'b10,
                       14'b0000_0000_0000_00,
                         tr0_IRQ,                    // tr0 general-purpose interrupt request
                         (NaN_q2 | INF_q2 | DML_q2), // floating-point exception (NaN | INF | DML)
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[16] : tr1_IRQ_IE,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[15] : tr1_EXC_IE,
                         NaN_q2,
                         INF_q2,
                         DML_q2,                         
                         NML_q2,                         
                         SZ_q2,                                     
                         FPN_q2,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[7] : tr1_done, 
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[6] : tr1_locked,
                         V_q2,     
                         N_q2,     
                         C_q2,     
                         Z_q2
...
assign  tr2_STATUSq2 = {2'b10,
                       14'b0000_0000_0000_00,
                         tr0_IRQ,                    // tr0 general-purpose interrupt request
                         (NaN_q2 | INF_q2 | DML_q2), // floating-point exception (NaN | INF | DML)
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[16] : tr2_IRQ_IE,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[15] : tr2_EXC_IE,
                         NaN_q2,
                         INF_q2,
                         DML_q2,                         
                         NML_q2,                         
                         SZ_q2,                                     
                         FPN_q2,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[7] : tr2_done, 
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[6] : tr2_locked,
                         V_q2,     
                         N_q2,     
                         C_q2,     
                         Z_q2
...
assign  tr3_STATUSq2 = {2'b10,			
                       14'b0000_0000_0000_00,
                         tr0_IRQ,                    // tr0 general-purpose interrupt request
                         (NaN_q2 | INF_q2 | DML_q2), // floating-point exception (NaN | INF | DML)
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[16] : tr3_IRQ_IE,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[15] : tr3_EXC_IE,
                         NaN_q2,
                         INF_q2,
                         DML_q2,                         
                         NML_q2,                         
                         SZ_q2,                                     
                         FPN_q2,
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[7] : tr3_done, 
                         ((dest_q2 == ST_ADDRS) & wrcycl) ? resultout[6] : tr3_locked,
                         V_q2,     
                         N_q2,     
                         C_q2,     
                         Z_q2
...
always @(posedge CLK or posedge RESET) begin                                                                     
    if (RESET) begin                                                                                             
        ...
        thread_q1 <= 2'b00; 
        pc_q1     <= 12'h100;                                                                               
        const_q1  <= 2'b00;         // 00 = no const lookup, 10 = const/read table (srcA), 01 = 8-bit immediate (srcB), 11 = 16-bit immediate                
        opcode_q1 <= 4'b0000;                                                                                  
        srcA_q1   <= 14'h0000;                                                                                
        srcB_q1   <= 14'h0000;                                                                                
        OPdest_q1 <= 8'h00;
...
////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////
        ...
        if (~(pipe_flush || RPT_not_z)) //begin
            ...
            if (&const)      //immediate loads of ARn occur during instruction fetch (state0)
                casex (newthreadq)
                    2'b00 : begin
...
//        end    
        ...
        if (~pipe_flush) begin
            if ( ~const[1])      //ARn auto-post-increment/decrement of indirect srcA address ARn occurs during instruction fetch (state0)
            ...
            if (~const[0])     //ARn auto-post-increment/decrement of indirect srcB address ARn occurs during instruction fetch (state0)
            casex (newthreadq)
                2'b00 : begin
                            casex (OPsrcB)
                                    8'h78 : tr0_AR0[13:0] <= tr0_AR0[13:0] + tr0_AR0[23:16];
