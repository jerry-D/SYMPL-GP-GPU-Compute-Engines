...
wire [31:0] RDDATA_gpu2;
wire [31:0] RDDATA_gpu3;

assign DONE = {gpu3_done, gpu2_done, gpu1_done, gpu0_done};
...
FP325 gpu2(
    ...
    .CLKB    (CLKB   ),
    .RESET   (RESET[2]),
    .WREN    (WREN & (WRADDRS[17:16]==2'b10)),
    .WRADDRS (WRADDRS[15:0]),
    .WRDATA  (WRDATA),
    .RDEN    (RDEN & (RDADDRS[17:16]==2'b10)),
    .RDADDRS (RDADDRS[15:0]),
    .RDDATA  (RDDATA_gpu2),
    .DONE    (gpu2_done)
    );
...
FP325 gpu3(
    ...
    .CLKB    (CLKB   ),
    .RESET   (RESET[3]),
    .WREN    (WREN & (WRADDRS[17:16]==2'b11)),
    .WRADDRS (WRADDRS[15:0]),
    .WRDATA  (WRDATA),
    .RDEN    (RDEN & (RDADDRS[17:16]==2'b11)),
    .RDADDRS (RDADDRS[15:0]),
    .RDDATA  (RDDATA_gpu3),
    .DONE    (gpu3_done)
    );
...
always @(*)
    case(gpu_sel)
        2'b00 : RDDATA = RDDATA_gpu0;
        2'b01 : RDDATA = RDDATA_gpu1;
        2'b10 : RDDATA = RDDATA_gpu2;
        2'b11 : RDDATA = RDDATA_gpu3;
    endcase    
            
always @(posedge CLKA)
    if (RDEN) gpu_sel <= RDADDRS[17:16];
    else gpu_sel <= 2'b00;
