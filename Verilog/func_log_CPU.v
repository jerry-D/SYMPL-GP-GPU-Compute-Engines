...
// Version:  2.07  January 18, 2016
// Copyright (C) 2014-2016.  All rights reserved.
//
// latency for log is 9 clocks
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                //
...
reg [6:0] delay0, delay1, delay2, delay3, delay4, delay5, delay6, delay7, delay8;
...
assign CPU_div_by_0  = div_by_0_del;
...
assign NaN_payload = {3'b000, wraddrsq[2:0], div_oob, 1'b0, pc_q2_del};  // the 1'b0 is reserved for future elongated 13-bit PC vs current 12-bit PC
...
assign A_is_infinite_del = delay8[6];
assign div_by_0_del = delay8[5];
assign invalid_del = delay8[4];
assign wrenq = delay8[3];
assign wraddrsq = delay8[2:0];
