...
assign indir_mode_srcA = ~const[1] & ~OPsrcA[7] & &OPsrcA[6:4] & |OPsrcA[3:2];
assign indir_mode_srcB = ~const[0] & ~OPsrcB[7]  & &OPsrcB[6:4]   & |OPsrcB[3:2];

assign dest = indir_mode_dest ?  DEST_ind  : {6'b000000, OPdest_q2[7:0]};
assign srcA = indir_mode_srcA ?  SRC_A_ind : {1'b0, const[1] & ~const[0], 4'b0000, OPsrcA[7:0]};
