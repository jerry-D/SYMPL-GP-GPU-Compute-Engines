...
assign dest = indir_mode_dest ?  (SP_push ? CPU_SP : DEST_ind)  : {16'h0000, OPdest_q2[7:0]};
assign srcA = indir_mode_srcA ?  (SP_popA ? CPU_SP_read : SRC_A_ind) : ((MOV_q0 & constn[1] & ~constn[0]) ? {constn[1] & ~constn[0], 7'h00, OPsrcA[7:0], OPsrcB[7:0]} : {constn[1] & ~constn[0], 15'h0000, OPsrcA[7:0]});
assign srcB = indir_mode_srcB ?  (SP_popB ? CPU_SP_read : SRC_B_ind) : {16'h0000, OPsrcB[7:0]};

// destination   
always @(*) begin
     case (DEST_ARn_sel) 
     	2'b00 : DEST_ind = CPU_AR0[23:0]; 
     	2'b01 : DEST_ind = CPU_AR1[23:0]; 
     	2'b10 : DEST_ind = CPU_AR2[23:0]; 
     	2'b11 : DEST_ind = CPU_AR3[23:0];
     endcase
end
...
always @(*) begin
   case (SRC_A_sel) 
   	   2'b00 : SRC_A_ind = CPU_AR0[23:0]; 
   	   2'b01 : SRC_A_ind = CPU_AR1[23:0]; 
   	   2'b10 : SRC_A_ind = CPU_AR2[23:0]; 
   	   2'b11 : SRC_A_ind = CPU_AR3[23:0];
   endcase
end
...
always @(*) begin
   case (SRC_B_sel) 
   	2'b00 : SRC_B_ind = CPU_AR0[23:0]; 
   	2'b01 : SRC_B_ind = CPU_AR1[23:0]; 
   	2'b10 : SRC_B_ind = CPU_AR2[23:0]; 
   	2'b11 : SRC_B_ind = CPU_AR3[23:0];
   endcase
end        
