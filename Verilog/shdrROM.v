 // parameterized tri-port 1 write-side and 2 read-side used for Shader ROM
 `timescale 1ns/1ns
...
module shdrROM #(parameter ADDRS_WIDTH = 12, parameter DATA_WIDTH = 32) (
    CLK,
    wren,
    wraddrs,
    wrdata,
...
initial begin
   ...
   while(i) 
    ...
    #1 
    $readmemh("Shader_olive.v",triportRAMA);	
    $readmemh("Shader_olive.v",triportRAMB);
end
