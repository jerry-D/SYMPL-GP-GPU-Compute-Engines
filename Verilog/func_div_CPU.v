...
reg [15:0] semaphor;  // one for each memory location  16 results 
//
reg readyA;
reg readyB;
...
assign NaN_payload = {2'b00, wraddrsq[3:0], div_oob, 1'b0, pc_q2_del};  // the 1'b0 is reserved for future elongated 13-bit PC vs current 12-bit PC
