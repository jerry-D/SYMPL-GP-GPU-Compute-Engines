...
reg [31:0] nA;
reg [5:0] delay0, delay1, delay2, delay3, delay4, delay5, delay6, delay7, delay8, delay9, delay10;
...
//assign NaN_payload = {wraddrsq[5:0], sqrt_oob, 1'b0, pc_q2_del};  // the 1'b0 is reserved for future elongated 13-bit PC vs current 12-bit PC
assign NaN_payload = {2'b00, wraddrsq[3:0], sqrt_oob, 1'b0, pc_q2_del};  // the 1'b0 is reserved for future elongated 13-bit PC vs current 12-bit PC
...
assign invalid_del = delay10[5];
assign wrenq = delay10[4];
assign wraddrsq = delay10[3:0];             
