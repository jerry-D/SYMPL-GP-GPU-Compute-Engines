...
module exc_capture_CPU (     // quasi-trace buffer
    CLK,
    RESET,
    srcA_q1,
    srcB_q1,
...
assign invalid = ready_in & (exc_codeA[3] | exc_codeB[3]);
assign divby0 = ready_in & ((exc_codeA[2:0]==_div_by_0_) | (exc_codeB[2:0]==_div_by_0_));
assign overflow = ready_in & (exc_codeA[2:0]==_overflow_) | (exc_codeB[2:0]==_overflow_);
assign underflow = ready_in & (exc_codeA[2:0]==_underflow_) | (exc_codeB[2:0]==_underflow_);
assign inexact = ready_in & (exc_codeA[2:0]==_inexact_) | (exc_codeB[2:0]==_inexact_);
...
always@(*) begin
    if (rdenA_q1) 
        case (selA)
            ...
            2'b11 : capt_dataA = {round_mode_q1_capt, pc_q1_capt, addrsMode_q1_capt, dest_q2_capt};
        endcase
...
always@(*) begin
    if (rdenB_q1) 
        case (selB)
            ...
            2'b11 : capt_dataB = {round_mode_q1_capt, pc_q1_capt, addrsMode_q1_capt, dest_q2_capt};
        endcase
    ...
    if (RESET) begin
        ...
        case (state)
            2'b00 : if (capture_enable) begin
                        ...
                        {round_mode_q1_capt, pc_q1_capt, addrsMode_q1_capt} <= {round_mode_q1, pc_q1[13:0], addrsMode_q1}; 
                        state <= 2'b01;
                    end
            2'b01 : begin
