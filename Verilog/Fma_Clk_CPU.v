...
reg [49:0] dot_accum[15:0];
reg [49:0] C_accum;

reg [4:0] wren_wraddrs_del0;
reg [4:0] wren_wraddrs_del1;
reg [4:0] wren_wraddrs_del2;
reg [4:0] wren_wraddrs_del3;
reg [4:0] wren_wraddrs_del4;
reg [4:0] wren_wraddrs_del5;
reg [4:0] wren_wraddrs_del6;
...
assign wraddrsA = wren_wraddrs_del6[3:0];
assign wrenA = wren_wraddrs_del6[4];
assign rdenB = wren_wraddrs_del0[4];
assign rdaddrsB = wren_wraddrs_del0[3:0];
assign Cq = CREG_sel ? {C, 15'h0000} : C_accum;

assign CREG_sel = CPU_CREG_wr & wren_wraddrs_del1[4];
...
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        ...
        if (CPU_CREG_wr)CPU_CREG_wr_q0 <= 1'b1;
        else if (CPU_CREG_wr_q0 && wren_wraddrs_del1[4]) CPU_CREG_wr_q0 <= 1'b0;
   end
end        

always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        wren_wraddrs_del0 <= 5'b00000;
        wren_wraddrs_del1 <= 5'b00000;
        wren_wraddrs_del2 <= 5'b00000;
        wren_wraddrs_del3 <= 5'b00000;
        wren_wraddrs_del4 <= 5'b00000;
        wren_wraddrs_del5 <= 5'b00000;
        wren_wraddrs_del6 <= 5'b00000;
    end
    else begin
        wren_wraddrs_del0 <= {wren, wraddrs[3:0]};
