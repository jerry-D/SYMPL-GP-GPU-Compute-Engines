...
/*
    ...
    FP_To_FXP #(.wE(8), .wF(23), .wFX_I(32), .wFX_F(1))
     ftoi_0(
      .nA (nAq_0),
      .nR (nR_0));
...
*/
    assign nR_01 = 32'h0_0000_0000;            
    assign nR_0  = 32'h0_0000_0000;            
    assign nR_1  = 32'h0_0000_0000;            
...
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        ...
        nA_sel <= ~nA_sel;
        if (nA_sel && wren) nAq_1 <= nA_FP;
        else if (wren) nAq_0 <= nA_FP;
    end    
end            
