 `timescale 1ns/100ps
// wrapper for FP DIV
// For use in SYMPL FP324-AXI4 multi-thread multi-processor only
// Author:  Jerry D. Harthcock
// Version:  2.001 August 19, 2015
// August 15, 2015
// Copyright (C) 2014-2015.  All rights reserved without prejudice.
//
// latency for FDIV is 15 clocks
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                               //
...
reg [31:0] nA, nB;
//reg [6:0] delay0, delay1, delay2, delay3, delay4, delay5, delay6, delay7, delay8, delay9, delay10, delay11, delay12, delay13, delay14;
reg [6:0] delay0, delay1, delay2, delay3, delay4, delay5, delay6, delay7, delay8, delay9;
...
//assign wrenq = delay14[6];
assign wrenq = delay9[6];
//assign wraddrsq = delay14[5:0];             
assign wraddrsq = delay9[5:0];             
