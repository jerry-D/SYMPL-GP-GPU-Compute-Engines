 // CGS_int_cntrl.v
 `timescale 1ns/100ps
 // Coarse-grained scheduler interrupt controller
...
assign NMI_RETI = NMI_in_service & (opcode_q2==MOV_) & (dest_q2==PC_ADDRS) & (srcA_q2==NMI_PC_SAVE) & wrcycl;
assign EXC_RETI = EXC_in_service & (opcode_q2==MOV_) & (dest_q2==PC_ADDRS) & (srcA_q2==EXC_PC_SAVE) & wrcycl;
assign IRQ_RETI = IRQ_in_service & (opcode_q2==MOV_) & (dest_q2==PC_ADDRS) & (srcA_q2==IRQ_PC_SAVE) & wrcycl;


assign saving_NMI_PC_COPY = NMI_in_service & (opcode_q2==MOV_) & (dest_q2==NMI_PC_SAVE) & (srcA_q2==PC_COPY) & wrcycl;
assign saving_EXC_PC_COPY = EXC_in_service & (opcode_q2==MOV_) & (dest_q2==EXC_PC_SAVE) & (srcA_q2==PC_COPY) & wrcycl;
assign saving_IRQ_PC_COPY = IRQ_in_service & (opcode_q2==MOV_) & (dest_q2==IRQ_PC_SAVE) & (srcA_q2==PC_COPY) & wrcycl;
